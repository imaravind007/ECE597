...
class RegistrationModule:
    def __init__(self, logFileName):
        ...
        header = tk.Label(self.window, text="Student Attendence System", width=80, height=2, fg="white", bg="#363e75",
                          font=('times', 18, 'bold', 'underline'))
        header.place(x=0, y=0)

        clientID = tk.Label(self.window, text="Number", width=10, height=2, fg="white", bg="#363e75", font=('times', 15))
        ...
        empID = tk.Label(self.window, text="A_Number", width=10, fg="white", bg="#363e75", height=2, font=('times', 15))
        ...
        self.message = tk.Label(self.window, text="", bg="white", fg="black", width=30, height=1,
                                activebackground="#e47911", font=('times', 15, 'bold'))
        ...
        takeImg = tk.Button(self.window, text="Take Images", command=self.collectUserImageForRegistration, fg="black", bg="#363e75", width=15,
                            height=2,
                            activebackground="#118ce1", font=('times', 15, ' bold '))
        takeImg.place(x=80, y=350)

        trainImg = tk.Button(self.window, text="Train Images", command=self.trainModel, fg="black", bg="#363e75", width=15,
                             height=2,
                             activebackground="#118ce1", font=('times', 15, ' bold '))
        trainImg.place(x=350, y=350)

        predictImg = tk.Button(self.window, text="Predict", command=self.makePrediction, fg="black", bg="#363e75",
                             width=15,
                             height=2,
                             activebackground="#118ce1", font=('times', 15, ' bold '))
        predictImg.place(x=600, y=350)

        quitWindow = tk.Button(self.window, text="Quit", command=self.close_window, fg="black", bg="#363e75", width=10, height=2,
                               activebackground="#118ce1", font=('times', 15, 'bold'))
        quitWindow.place(x=650, y=510)

        link2 = tk.Label(self.window, text="aramanathan2@hawk.iit.edu", fg="blue", )
        link2.place(x=690, y=580)
        # link2.pack()
        link2.bind("<Button-1>", lambda e: self.callback("https://github.com/imaravind007"))
